...
namespace ASP_Identity.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.IsLockedOut)
                {
                    ...
                    //user.LockoutEnd = new DateTime().AddMinutes(1);
                    user.Nombre = "Jose";
                    ...
                    IdentityResult resultChanged = await _userManager.UpdateAsync(user);
